...
annotate_regions <- function(df, output_dir, name, gene.obj, cgi.obj, reg.obj) {
  ...
  # Add "other" category to the annotation slot
  regDMRann_hyper@annotation["other"] <- 100-sum(regDMRann_hyper@precedence)
  regDMRann_hypo@annotation["other"] <- 100-sum(regDMRann_hypo@precedence)

  regDMRann_hyper@precedence["other"] <- 100-sum(regDMRann_hyper@precedence)
  regDMRann_hypo@precedence["other"] <- 100-sum(regDMRann_hypo@precedence)

  regDMRann_hyper@num.annotation["other"] <- Inf
  regDMRann_hypo@num.annotation["other"] <- Inf

  regDMRann_hyper@num.precedence["other"] <- Inf
  regDMRann_hypo@num.precedence["other"] <- Inf
